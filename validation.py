...
from models.grid_proto_fewshot_my import FewShotSeg
# from models.fewshot_my import FewShotSeg
...
#                 with torch.no_grad():
#                     if i < 10:
#                         print("sup_img_part[0][0].shape", sup_img_part[0][0].shape)
#                         test_sup_img = sup_fgm_part[0][0]
#                         test_sup_img = sup_fgm_part[0][0].cpu().numpy().reshape(test_sup_img.shape[1], test_sup_img.shape[2])
#                         print(test_sup_img.max())
#                         cv2.imwrite("test_sup_img%d.png" % i, test_sup_img * 255)
#                         i += 1
