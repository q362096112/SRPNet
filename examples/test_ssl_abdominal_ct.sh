...
do
    ...
    RELOAD_PATH='./exps/myexp_MIDDLE_0/mySSL_train_SABS_Superpix_lbgroup0_scale_MIDDLE_vfold4_SABS_Superpix_sets_0_1shot/2/snapshots/25000.pth' # path to the reloaded model
