...
ALL_EV=( 3) # 5-fold cross validation (0, 1, 2, 3, 4)
...
do
    ...
    RELOAD_PATH='./exps/myexperiments_MIDDLE_0/mySSL_train_CHAOST2_Superpix_lbgroup0_scale_MIDDLE_vfold1_CHAOST2_Superpix_sets_0_1shot/3/snapshots/best.pth' # path to the reloaded model
