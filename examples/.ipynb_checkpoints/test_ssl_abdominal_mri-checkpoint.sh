...
do
    ...
    RELOAD_PATH='./exps/myexperiments_MIDDLE_1/mySSL_train_CHAOST2_Superpix_lbgroup1_scale_MIDDLE_vfold4_CHAOST2_Superpix_sets_1_1shot/1/snapshots/100000.pth' # path to the reloaded model
